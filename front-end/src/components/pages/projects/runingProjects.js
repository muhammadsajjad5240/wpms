// below we import moduls for componetn
...
export default class RuningProjects extends Component {
    ...
    // below we create method to handle project id
    handleSearchProjectId = (e) => {
        this.setState({ search_project_id: e.target.value });
    }
    // below we create method to handle porject name
    ...
    // belwo we create method that will call when the componetn will load
    componentDidMount() {
        // belwo we send request to the server to get runnign project
        axios.post('/Projects/runingProjects')
            .then(res => {
    ...
    // below we create method to search record
    searchRecord = () => {
        ...
        if (project_id === "" && project_name === "" && project_type === "Project Type") {
            ...
            axios.post('/Projects/searchRuningProjectId/', { project_id: this.state.search_project_id })
                .then((res) => {
            ...
            document.getElementById('emp_msg').style.display = 'none';
            axios.post('/Projects/searchRuningProjectName/', { project_name: this.state.search_project_name })
                .then((res) => {
                    this.setState({ searchProject: res.data });
                    if (res.data.length === 0) {
                        document.getElementById('not_record_msg').style.display = 'block';
            ...
            document.getElementById('emp_msg').style.display = 'none';
            axios.post('/Projects/searchRuningProjectType/', { project_type: this.state.search_project_type })
                .then((res) => {
                    this.setState({ searchProject: res.data });
                    if (res.data.length === 0) {
                        document.getElementById('not_record_msg').style.display = 'block';
            ...
            document.getElementById('emp_msg').style.display = 'none';
            axios.post('/Projects/searchRuningProjectIdName/', { project_id: this.state.search_project_id, project_name: this.state.search_project_name })
                .then((res) => {
                    this.setState({ searchProject: res.data });
                    if (res.data.length === 0) {
                        document.getElementById('not_record_msg').style.display = 'block';
            ...
            document.getElementById('emp_msg').style.display = 'none';
            axios.post('/Projects/searchRuningProjectNameType/', { project_name: this.state.search_project_name, project_type: this.state.search_project_type })
                .then((res) => {
                    this.setState({ searchProject: res.data });
                    if (res.data.length === 0) {
                        document.getElementById('not_record_msg').style.display = 'block';
            ...
            document.getElementById('emp_msg').style.display = 'none';
            axios.post('/Projects/searchRuningProjectIdType/', { project_id: this.state.search_project_id, project_type: this.state.search_project_type })
                .then((res) => {
                    this.setState({ searchProject: res.data });
                    if (res.data.length === 0) {
                        document.getElementById('not_record_msg').style.display = 'block';
            ...
            document.getElementById('emp_msg').style.display = 'none';
            axios.post('/Projects/searchRuningProjectIdNameType/', { project_id: this.state.search_project_id, project_name: this.state.search_project_name, project_type: this.state.search_project_type })
                .then((res) => {
                    this.setState({ searchProject: res.data });
                    if (res.data.length === 0) {
                        document.getElementById('not_record_msg').style.display = 'block';
                    ...
                    <div className='col-sm-4'>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" style={{ color: 'grey' }}>Runing Projects</li>
                            </ol>
                        </nav>
                    </div>
