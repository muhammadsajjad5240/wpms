...
// below we create css for input field
const lableStyle = {
    color: '#000',
    fontSize: '14px',
    fontWeight: '700'
...
class AddBill extends Component {
    ...
    constructor(props) {
        ...
        this.handlepurchaseFrom = this.handlepurchaseFrom.bind(this);
        this.handlePurchaseDate = this.handlePurchaseDate.bind(this);
        this.handlePurchaseBy = this.handlePurchaseBy.bind(this);
        this.handleAmount = this.handleAmount.bind(this);
        this.handlePaidBy = this.handlePaidBy.bind(this);
    ...
    // below we create method to check validation and handle Item Name
    handleItemName = (e) => {
        ...
        if (!letters.test(item_name)) {
            ...
            document.getElementById('namelable').style.color = '#000';
        }
    }
    // below we create method to check validation and handle Purchase From
    handlepurchaseFrom = (e) => {
        ...
        if (!letters.test(purchase_from)) {
            ...
            document.getElementById('purchaseFrom').style.color = '#000';
        }
    }
    ...
    handlePurchaseDate = (e) => {
        ...
        if (purchase_date === "") {
            ...
            document.getElementById('purchaseDate').style.color = '#000';
        }
    }
    // below we create method to check validation and handle Purchase By
    handlePurchaseBy = (e) => {
        ...
        if (purchase_by === "Purchase By" || purchase_by === "Not Present") {
            ...
            document.getElementById('purchaseBy').style.color = '#000';
        }
    }
    ...
    handleAmount = (e) => {
        ...
        if (amount === "") {
            ...
            document.getElementById('amountlbl').style.color = '#000';
        }
    }
    ...
    handlePaidBy = (e) => {
        ...
        if (paid_by === "Paid By") {
            ...
            document.getElementById('padiBylbl').style.color = '#000';
        }
    }
    // below we create method to check validation submit data
    handleSubmit = (e) => {
        ...
        axios.post('/Employee/getEmployeeNames')
            .then(res => {
                // Below we set the employee name to the state
        ...
        if (!itemNamePattern.test(item_name)) {
            ...
            // below we create object and send this object to the server to store data
            let newBill = {
            ...
            axios.post('/Bills/addBill', newBill)
                .then(res => {
                    ...
                    if (a === "OK") {
                        ...
                        doc.setFontSize(10)
                        doc.setTextColor('#000')
                        doc.text(480, 420, this.state.amount)
                        // 
                        doc.setFontSize(10)
                        doc.setTextColor('#000')
                        doc.setFontType("bold");
    ...
    // below we create method that will call when the use focus on input field
    myfocus = (a) => {
        document.getElementById(a).style.border = "1px solid grey";
    }
    // below we create the method that will load when the component load
    componentDidMount = () => {
        let n = new Date();
        let y = n.getFullYear();
        let m = n.getMonth() + 1;
        ...
        this.setState({ bill_id: text });
        // below we send requet to the server to get emplyoee names from the server
        axios.post('/Bills/getEmployeeNames')
            .then(res => {
                // below we set the state with data from the server
        ...
        return (
            <div id='add_employee'>
                <div class="alert alert-success alert-dismissible fade show" id="success_alert" role="alert" style={{ display: 'none' }}>
                    <strong>New Bill Add Successfully</strong>
                ...
                <form id='add_emp_form'>
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="item_name" style={inputStyle} name='item_name' onFocus={() => this.myfocus('item_name')} value={this.state.item_name} onChange={this.handleItemName} placeholder="Item name" title='Item name' />
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" id="purchase_by" style={inputStyle} name='purchaseBy' onFocus={() => this.myfocus('purchase_by')} value={this.state.purchase_by} onChange={this.handlePurchaseBy} title='Purchase By'>
                                <option value="Purchase By">Purchase By</option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" maxLength='6' id="_amount" style={inputStyle} name='amount' onFocus={() => this.myfocus('_amount')} value={this.state.amount} onChange={this.handleAmount} title="Amount" />
                            <div class="valid-feedback">
                                Looks good!
                                     </div>
                        </div>
                    ...
                    <div className='row'>
                        <div className='col-sm-3 offset-sm-4 mr-4'>
                            <button class="btn" onClick={this.handleSubmit} style={{ backgroundColor: '#f43b48', color: 'white', fontWeight: 700 }}>Add Bill</button>
                        </div>
                    </div>
                </form>
            </div>
