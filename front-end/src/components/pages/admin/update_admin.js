...
class UpdateAdmin extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            admins: [],
            update_admin_name: '',
            update_admin_user_name: '',
            update_admin_password: '',
            update_admin_email: '',
            update_admin_id: '',
            update_admin_joining_date:'',
    ...
    handleAdminName = (e) => {
        this.setState({ update_admin_name: e.target.value });
        let letters = /^[a-zA-Z ]+$/;
    ...
    handleAdminUserName = (e) => {
        this.setState({ update_admin_user_name: e.target.value });
    ...
    handleAdminPassword = (e) => {
        this.setState({ update_admin_password: e.target.value });
        let letters = /^[a-zA-Z0-9]+$/;
    ...
    handleAdminEmail = (e) => {
        this.setState({ update_admin_email: e.target.value });
    ...
    handleAdminPhone = (e) => {
        this.setState({ update_admin_phone: e.target.value });
    ...
    handleAdminAddress = (e) => {
        this.setState({ update_admin_address: e.target.value });
    ...
    handleJoiningDate = (e) =>{
        this.setState({update_joining_date : e.target.value});
    }
    // below we create method to handle Gender
    handleGender = (e) => {
        this.setState({ update_gender: e.target.value });
    }
    ...
    updateAdmin = (e) => {
        ...
        if (!userNamePattern.test(user_name) || user_name < 6) {
            document.getElementById('update_user_name').style.border = '1px solid red';
        }
            ...
            axios.post('/Admin/updateAdmin', {
                id: this.state.update_admin_id,
                fullName: this.state.update_admin_name,
                userName: this.state.update_admin_user_name,
                email: this.state.update_admin_email,
                adminId: this.state.update_admin_id,
                phone: this.state.update_admin_phone,
                joiningDate: this.state.update_joining_date,
                password: this.state.update_admin_password,
                address: this.state.update_admin_address,
                gender: this.state.update_gender
            })
                .then(res => {
    ...
    componentDidMount = () => {
        ...
        axios.post('/Admin/getAdminDataForUpdate', {})
            .then(res => {
                ...
                this.setState({ update_admin_name: obj.fullName })
                this.setState({ update_admin_user_name: obj.userName })
                this.setState({ update_admin_email: obj.email })
                this.setState({ update_admin_id: obj.adminId })
                this.setState({ update_admin_phone: obj.phone })
                this.setState({ update_admin_address: obj.address })
                this.setState({update_joining_date : obj.joiningDate})
                this.setState({ update_gender: obj.gender });
                this.setState({ update_admin_password: obj.password })
                if (this.state.update_gender === "male") {
                    document.getElementById('_male').checked = true;
                }
                else if (this.state.update_gender === "female") {
                ...
                <form>
                    <div class="form-row">
                        ...
                        <div class="col-md-4">
                            ...
                            {/* <input type="text" class="form-control" maxLength='15' style={inputStyle} id="update_admin_name" name='clienttName' onFocus={() => this.myfocus('update_admin_name')} value={this.state.update_admin_name} onChange={this.handleAdminName} placeholder="Client name" title='Client name' /> */}
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" style={inputStyle} id="update_admin_email" name="clientEmail" onFocus={() => this.myfocus('update_admin_email')} rows="1" value={this.state.update_admin_email} onChange={this.handleAdminEmail} placeholder="Client Email" />
                            <div class="valid-feedback">
                                Looks good!
                                 </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" style={inputStyle} id="update_user_name" name='userName' onFocus={() => this.myfocus('update_user_name')} value={this.state.update_admin_user_name} onChange={this.handleAdminUserName} readOnly placeholder="User Name" title='User Name' />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="userName" style={lableStyle}>Password</label>
                                <input type="password" class="form-control" style={inputStyle} id="update_password" name='password' onFocus={() => this.myfocus('update_password')} value={this.state.update_admin_password} onChange={this.handleAdminPassword} placeholder="PAssword" title='Password' />
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" style={inputStyle} id="update_admin_id" name="clientID" readOnly onFocus={() => this.myfocus('update_admin_id')} rows="1" value={this.state.update_admin_id} placeholder="Client ID" />
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" style={inputStyle} id="update_admin_phone" name='clientPhone' onFocus={() => this.myfocus('update_admin_phone')} value={this.state.update_admin_phone} onChange={this.handleAdminPhone} title="Client Phone" />
                    ...
                    <div class="form-row pt-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type='date' id='update_joining_date' class="form-control" name='joiningDate' onFocus={() => this.myfocus('update_joining_date')} value={this.state.update_joining_date} onChange={this.handleJoiningDate} title='Joining Date' />
                            <div class="valid-feedback">
                                Looks good!
                                 </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <textarea class="form-control" style={inputStyle} id="admin_address" row="1" name='clientAddress' onFocus={() => this.myfocus('update_admin_address')} value={this.state.update_admin_address} onChange={this.handleAdminAddress} title='Client Address' ></textarea>
                            <div class="valid-feedback">
                                Looks good!
                                 </div>
                        </div>
                    ...
                    <div className='row'>
                        <div className='col-sm-3 offset-sm-5 mr-4'>
                            <button class="btn" onClick={this.updateAdmin} style={{ backgroundColor: '#f43b48', color: 'white', fontWeight: 700 }}>Update Admin</button>
                        </div>
                    </div>
                </form>
            </div>
